...
class User():
    ...
    def password(self, pwd):
        ...
        if pwd is None or type(pwd) is not str:
            ...
            self.__password = hashlib.md5(pwd.encode()).hexdigest().lower()  # ✅ Fix: Store the hash correctly
    ...
    def is_valid_password(self, pwd):
        ...
        if self.__password is None:
            return False
        return hashlib.md5(pwd.encode()).hexdigest().lower() == self.__password  # ✅ Fix: Ensure consistent hash case
...
if __name__ == '__main__':
    ...
    if user_2.is_valid_password("No pwd"):
        print("is_valid_password should return False if no password was set before")
